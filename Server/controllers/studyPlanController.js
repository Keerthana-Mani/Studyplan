//To control database operation related to study plans in mongodb controlling the schema
...
export const getStudyPlans = async (req, res) => {
    try {
        ...
        return res.status(500).json({ message: 'Error fetching study plans', error: error.message });
    }
}
